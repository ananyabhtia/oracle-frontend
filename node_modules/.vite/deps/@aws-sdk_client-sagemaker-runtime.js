...
// node_modules/@aws-sdk/client-sagemaker-runtime/dist-es/auth/httpAuthSchemeProvider.js
var defaultSageMakerRuntimeHttpAuthSchemeParametersProvider = async (config, context, input) => {
  return {
...
var defaultSageMakerRuntimeHttpAuthSchemeProvider = (authParameters) => {
  const options = [];
...
// node_modules/@aws-sdk/client-sagemaker-runtime/dist-es/endpoint/EndpointParameters.js
...
// node_modules/@aws-sdk/client-sagemaker-runtime/package.json
var package_default = {
  ...
  repository: {
    ...
    directory: "clients/client-sagemaker-runtime"
  }
};
...
// node_modules/@aws-sdk/client-sagemaker-runtime/dist-es/endpoint/ruleset.js
var u = "required";
var v = "fn";
var w = "argv";
var x = "ref";
...
var n = {};
var o = { [v]: "getAttr", [w]: [{ [x]: g }, "supportsFIPS"] };
var p = { [v]: c, [w]: [true, { [v]: "getAttr", [w]: [{ [x]: g }, "supportsDualStack"] }] };
var q = { [v]: "getAttr", [w]: [{ [x]: g }, "name"] };
var r = [l];
var s = [m];
var t = [{ [x]: "Region" }];
...
// node_modules/@aws-sdk/client-sagemaker-runtime/dist-es/endpoint/endpointResolver.js
...
// node_modules/@aws-sdk/client-sagemaker-runtime/dist-es/runtimeConfig.shared.js
var getRuntimeConfig = (config) => {
  return {
    ...
    httpAuthSchemeProvider: (config == null ? void 0 : config.httpAuthSchemeProvider) ?? defaultSageMakerRuntimeHttpAuthSchemeProvider,
    ...
    protocol: (config == null ? void 0 : config.protocol) ?? new AwsRestJsonProtocol({ defaultNamespace: "com.amazonaws.sagemakerruntime" }),
    serviceId: (config == null ? void 0 : config.serviceId) ?? "SageMaker Runtime",
...
// node_modules/@aws-sdk/client-sagemaker-runtime/dist-es/runtimeConfig.browser.js
...
// node_modules/@aws-sdk/client-sagemaker-runtime/dist-es/auth/httpAuthExtensionConfiguration.js
...
// node_modules/@aws-sdk/client-sagemaker-runtime/dist-es/runtimeExtensions.js
...
// node_modules/@aws-sdk/client-sagemaker-runtime/dist-es/SageMakerRuntimeClient.js
var SageMakerRuntimeClient = class extends Client {
...
// node_modules/@aws-sdk/client-sagemaker-runtime/dist-es/models/SageMakerRuntimeServiceException.js
var SageMakerRuntimeServiceException = class _SageMakerRuntimeServiceException extends ServiceException {
  constructor(options) {
    super(options);
...
// node_modules/@aws-sdk/client-sagemaker-runtime/dist-es/models/errors.js
var InternalDependencyException = class _InternalDependencyException extends SageMakerRuntimeServiceException {
  constructor(opts) {
    ...
    __publicField(this, "name", "InternalDependencyException");
...
var InternalFailure = class _InternalFailure extends SageMakerRuntimeServiceException {
  constructor(opts) {
    ...
    __publicField(this, "name", "InternalFailure");
    __publicField(this, "$fault", "server");
    __publicField(this, "Message");
...
var ServiceUnavailable = class _ServiceUnavailable extends SageMakerRuntimeServiceException {
  constructor(opts) {
    ...
    __publicField(this, "name", "ServiceUnavailable");
    __publicField(this, "$fault", "server");
    __publicField(this, "Message");
...
var InternalStreamFailure = class _InternalStreamFailure extends SageMakerRuntimeServiceException {
  constructor(opts) {
    ...
    __publicField(this, "name", "InternalStreamFailure");
    __publicField(this, "$fault", "server");
    __publicField(this, "Message");
...
var ModelStreamError = class _ModelStreamError extends SageMakerRuntimeServiceException {
  constructor(opts) {
    ...
    __publicField(this, "name", "ModelStreamError");
    __publicField(this, "$fault", "client");
    __publicField(this, "Message");
...
// node_modules/@aws-sdk/client-sagemaker-runtime/dist-es/schemas/schemas_0.js
var _A = "Accept";
var _B = "Body";
var _BB = "BodyBlob";
var _By = "Bytes";
var _CA = "CustomAttributes";
var _CAH = "CustomAttributesHeader";
...
var _IDE = "InternalDependencyException";
var _IE = "InvokeEndpoint";
var _IEA = "InvokeEndpointAsync";
var _IEAI = "InvokeEndpointAsyncInput";
var _IEAO = "InvokeEndpointAsyncOutput";
var _IEI = "InvokeEndpointInput";
var _IEO = "InvokeEndpointOutput";
var _IEWRS = "InvokeEndpointWithResponseStream";
var _IEWRSI = "InvokeEndpointWithResponseStreamInput";
var _IEWRSO = "InvokeEndpointWithResponseStreamOutput";
var _IF = "InternalFailure";
var _II = "InferenceId";
var _IL = "InputLocation";
var _IPV = "InvokedProductionVariant";
var _ISF = "InternalStreamFailure";
var _ITS = "InvocationTimeoutSeconds";
var _LSA = "LogStreamArn";
var _M = "Message";
var _ME = "ModelError";
var _MNRE = "ModelNotReadyException";
var _MSE = "ModelStreamError";
...
TypeRegistry.for(n0).registerError(InternalDependencyException2, InternalDependencyException);
var InternalFailure2 = [
  -3,
  n0,
  _IF,
  {
...
TypeRegistry.for(n0).registerError(InternalFailure2, InternalFailure);
var InternalStreamFailure2 = [
  -3,
  n0,
  _ISF,
  {
...
TypeRegistry.for(n0).registerError(InternalStreamFailure2, InternalStreamFailure);
...
TypeRegistry.for(n0).registerError(ModelError2, ModelError);
...
TypeRegistry.for(n0).registerError(ModelStreamError2, ModelStreamError);
var PayloadPart = [
  3,
  n0,
  _PP,
...
TypeRegistry.for(n0).registerError(ServiceUnavailable2, ServiceUnavailable);
...
TypeRegistry.for(n0).registerError(ValidationError2, ValidationError);
var SageMakerRuntimeServiceException2 = [
  -3,
  _sm,
...
TypeRegistry.for(_sm).registerError(SageMakerRuntimeServiceException2, SageMakerRuntimeServiceException);
var ResponseStream = [
  3,
  n0,
  _RS,
...
// node_modules/@aws-sdk/client-sagemaker-runtime/dist-es/commands/InvokeEndpointAsyncCommand.js
var InvokeEndpointAsyncCommand = class extends Command.classBuilder().ep(commonParams).m(function(Command2, cs, config, o2) {
  return [getEndpointPlugin(config, Command2.getEndpointParameterInstructions())];
}).s("AmazonSageMakerRuntime", "InvokeEndpointAsync", {}).n("SageMakerRuntimeClient", "InvokeEndpointAsyncCommand").sc(InvokeEndpointAsync).build() {
};

// node_modules/@aws-sdk/client-sagemaker-runtime/dist-es/commands/InvokeEndpointCommand.js
var InvokeEndpointCommand = class extends Command.classBuilder().ep(commonParams).m(function(Command2, cs, config, o2) {
  return [getEndpointPlugin(config, Command2.getEndpointParameterInstructions())];
}).s("AmazonSageMakerRuntime", "InvokeEndpoint", {}).n("SageMakerRuntimeClient", "InvokeEndpointCommand").sc(InvokeEndpoint).build() {
};

// node_modules/@aws-sdk/client-sagemaker-runtime/dist-es/commands/InvokeEndpointWithResponseStreamCommand.js
var InvokeEndpointWithResponseStreamCommand = class extends Command.classBuilder().ep(commonParams).m(function(Command2, cs, config, o2) {
  return [getEndpointPlugin(config, Command2.getEndpointParameterInstructions())];
}).s("AmazonSageMakerRuntime", "InvokeEndpointWithResponseStream", {
  eventStream: {
    output: true
  }
}).n("SageMakerRuntimeClient", "InvokeEndpointWithResponseStreamCommand").sc(InvokeEndpointWithResponseStream).build() {
};

// node_modules/@aws-sdk/client-sagemaker-runtime/dist-es/SageMakerRuntime.js
var commands = {
...
//# sourceMappingURL=@aws-sdk_client-sagemaker-runtime.js.map
